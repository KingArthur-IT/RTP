<template>
  <div class="mail">
      <div class="mail__hero">
          ...
          <a href="mailto:info@rosturplast.ru" class="mail__adress">info@rosturplast.ru</a>
          <div class="mail__description mail__mb">по остальным вопросам</div>
          
          <a href="mailto:zakaz@rosturplast.ru" class="mail__adress">zakaz@rosturplast.ru</a>
